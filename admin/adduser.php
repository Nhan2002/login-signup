...
<body>
    <div class="container">
        <form action="adduser.php" method="post">
            <center>
                <h2 class="justify-content-md-center">Thêm user</h2>
            </center>
            ...
            if (isset($_POST["signup"])) {
                ...
                if (!empty($email) && !empty($fullname) && !empty($password)) {
                    ...
                    <strong>Thêm user thất bại:</strong> Bạn cần nhập đầy đủ thông tin
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                    </div>';
            ...
            ?>
            <button type="submit" class="btn btn-outline-success btn-lg btn-block" name="signup">thêm</button>
