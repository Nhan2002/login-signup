...
<body>
    <div class="container">
        <form action="index.php" method="post">
            <center>
                <h2 class="justify-content-md-center">Đăng nhâp trang admin</h2>
            </center>
            ...
            if (isset($_POST['login'])) {
                ...
                if (!empty($email) && !empty($password)) {
                    ...
                    if (mysqli_num_rows($query) > 0) {
                        $role = "SELECT * FROM `user` WHERE `ID_Role` = 1";
                        ...
                        if(mysqli_num_rows($query) > 0) {
                            ...
                            <strong>Đăng nhập thất bại:</strong> tài khoản của bạn không phải là tài khoản admin
